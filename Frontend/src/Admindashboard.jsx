            ...
            <div style={{ padding: '20px', display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(190px, 1fr))', gap: 14 }}>
              {QUICK_ACTIONS.map(a => (
                <div
                  ...
                  style={{
                    background: '#f9fafb', borderRadius: 14, padding: '20px 18px',
                    cursor: 'pointer', border: '1.5px solid #eef0f6',
                    transition: 'all 0.2s'
                  }}
                  onMouseOver={e => { e.currentTarget.style.borderColor = '#6366f1'; e.currentTarget.style.background = '#f0efff'; }}
                  onMouseOut={e  => { e.currentTarget.style.borderColor = '#eef0f6'; e.currentTarget.style.background = '#f9fafb'; }}
                >
                  <div style={{ fontSize: 28, marginBottom: 10 }}>{a.icon}</div>
                  <div style={{ fontWeight: 700, fontSize: 15, color: '#1e1b4b', marginBottom: 3 }}>{a.label}</div>
